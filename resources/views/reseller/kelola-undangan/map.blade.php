    ...
    <div class="bg-white/70 backdrop-blur-xl border border-white rounded-[2rem] p-12 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] min-h-[400px] flex flex-col items-center justify-center">
        ...
        @if(!$eventWithMap)
            <div class="text-center text-slate-400">
                ...
                <a href="{{ route('reseller.kelola-undangan.edit', $invitation->id) }}" class="inline-flex items-center gap-2 mt-6 bg-[#6d28d9] hover:bg-[#5b21b6] text-white px-6 py-2.5 rounded-full font-medium text-[14px] transition-all shadow-sm">
                    Edit Undangan
                </a>
            </div>
        @else
