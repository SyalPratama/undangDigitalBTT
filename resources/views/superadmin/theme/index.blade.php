    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-slate-100 shadow-xs p-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <div>
                    <h3 class="text-lg font-bold text-slate-800">Daftar Manajemen Tema</h3>
                    <p class="text-xs text-slate-400 mt-0.5 font-sans">Kelola desain template dan tema visual untuk aplikasi
