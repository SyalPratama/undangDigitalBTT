...
<body class="bg-[#09090b] text-[#f4f4f5] antialiased envelope-active">
    ...
    <div id="envelopeOverlay"
        ...
        <div class="max-w-xl text-center px-6 z-10">
            ...
            <h2
                ...
                Tasyakuran Khitan
                <span
                    class="block neon-gold-text font-accent lowercase italic font-normal tracking-normal py-2">{{ $invitation->profile->first_name ?? 'Putra Tercinta Kami' }}</span>
            </h2>
    ...
    <section class="relative min-h-screen grid md:grid-cols-12 items-stretch overflow-hidden">
        <div
            ...
            <div class="flex justify-between items-center">
                <span class="font-header text-xs text-[#f59e0b] tracking-widest font-bold">KHITANAN CELEBRATION</span>
            ...
            <div class="my-auto py-16 md:py-0 relative">
                <h1
                    ...
                    KHITAN</h1>
                <p class="font-accent text-3xl italic text-[#f59e0b] mb-4">Masyasykur atas khitan putra kami...</p>
                <h2
                ...
                <h2
                    ...
                    {{ $invitation->profile->second_name ?? 'Putra Tercinta' }}
                </h2>
                <p class="text-sm text-zinc-400 font-light max-w-sm leading-relaxed">
                    Tiada kata yang lebih indah selain ungkapan rasa syukur kehadirat Allah SWT yang telah memberikan
                    kelancaran atas syariat khitan putra kami, yang menjadi salah satu tahapan penting dalam menuju
                    kedewasaan dan ketakwaan.
                </p>
            </div>
        ...
        <div class="md:col-span-6 relative min-h-[40vh] md:min-h-screen flex items-end p-8 md:p-16">
            ...
            <div class="relative z-10 max-w-sm neon-gold-border bg-[#09090b]/80 backdrop-blur-md p-6 rounded-2xl">
                ...
                <p class="font-accent text-sm text-zinc-200 leading-relaxed italic">
                    "{{ $invitation->profile->quote ?? 'Semoga Allah memberikan keberkahan padamu, memberkati perjuanganmu, dan menjadikanmu anak yang sholeh yang berbakti kepada kedua orang tua serta berguna bagi agama.' }}"
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#09090b] py-36 px-6 relative overflow-hidden text-center">
        <div class="max-w-xl mx-auto relative">
            ...
            <span class="font-header text-[10px] text-[#f59e0b] tracking-[0.4em] block uppercase mb-2">Putra Tercinta
                Kami</span>
            ...
            <p class="text-sm text-zinc-400 leading-relaxed font-light">
                Ungkapan rasa syukur yang tak terhingga kepada Allah SWT atas terlaksananya syariat khitan putra kami
                tercinta. Bersama
                ...
                sangat mengharapkan kehadiran serta doa restu Bapak/Ibu sekalian untuk mengiringi tumbuh kembang serta
                kesholehan putra kami.
            </p>
        </div>
    </section>
    ...
    <section class="py-40 px-6 bg-[#141416] relative text-center border-t border-zinc-800">
        ...
        <div class="max-w-3xl mx-auto z-10 relative">
            ...
            <p class="text-zinc-400 font-light text-sm md:text-base leading-loose max-w-xl mx-auto mb-12">
                Kehadiran dan untaian doa tulus dari Bapak/Ibu/Saudara/i sekalian adalah berkah berharga yang mengiringi
                langkah awal buah hati kami menuju kesucian diri. Semoga kebaikan senantiasa menyelimuti kita semua.
            </p>
    ...
    <script>
        const audio = document.getElementById('khitanMusic');
