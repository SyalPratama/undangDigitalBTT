...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Anton&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Sacramento&family=Courier+Prime:ital,wght@0,400;0,700&display=swap"
        rel="stylesheet">
    ...
    <style>
        ...
        *::after {
        ...
        .mq-i {
            display: inline-flex;
            animation: mq-anim 18s linear infinite
        }
...
═══════════════════════════════════ */
        ...
        .sdot.on {
            ...
            height: 18px;
            border-radius: 3px;
            box-shadow: 0 0 8px rgba(214, 40, 40, .5)
        }
        ...
        #music-btn {
            ...
            border: 1px solid rgba(242, 237, 230, .15);
            border-radius: 50%;
            display: none;
            align-items: center;
            justify-content: center;
...
═══════════════════════════════════ */
        ...
        .s1-scroll::after {
            ...
            flex: 1;
            height: 1px;
            background: rgba(242, 237, 230, .12);
            max-width: 50px
        }
...
═══════════════════════════════════ */
        ...
        .s5-grid .gi:nth-child(1) {
            grid-column: span 5;
            grid-row: span 2
        }

        .s5-grid .gi:nth-child(2) {
            grid-column: span 4;
            grid-row: span 1
        }

        .s5-grid .gi:nth-child(3) {
            grid-column: span 3;
            grid-row: span 1
        }

        .s5-grid .gi:nth-child(4) {
            grid-column: span 4;
            grid-row: span 1
        }

        .s5-grid .gi:nth-child(5) {
            grid-column: span 3;
            grid-row: span 1
        }

        .s5-grid .gi:nth-child(n+6) {
            grid-column: span 3;
            grid-row: span 1
        }
...
═══════════════════════════════════ */
        ...
        .s6-inp {
            ...
            background: transparent;
            border: none;
            border-bottom: 1.5px solid rgba(17, 17, 17, .22);
            padding: 12px 0;
            font-family: 'Libre Baskerville', serif;
            font-size: 13px;
            color: #111;
...
═══════════════════════════════════ */
        ...
        #wlist {
            ...
            scrollbar-color: rgba(17, 17, 17, .12) transparent
        }
...
═══════════════════════════════════ */
        ...
        .s8-qris {
            border: 1.5px dashed rgba(242, 237, 230, .14);
        ...
        .s8-qr-box {
            ...
            margin: 16px auto 0;
            border: 1px dashed rgba(242, 237, 230, .1);
            display: flex;
            align-items: center;
            justify-content: center;
            font-size: 2rem;
...
═══════════════════════════════════ */
        ...
        .s9-center {
            ...
            align-items: center;
            justify-content: center;
            padding: clamp(20px, 3vw, 40px) clamp(20px, 5vw, 60px);
            text-align: center;
        }
...
═══════════════════════════════════ */
        @media(max-width:768px) {
            ...
            .s5-grid .gi:nth-child(n) {
                grid-column: span 1 !important;
                grid-row: span 1 !important
            }

            .s5-grid .gi:first-child {
                grid-column: span 2 !important;
                grid-row: span 1 !important
            }

            .s5-grid .gi:nth-child(n+7) {
                display: none !important
            }
            ...
            .s9-mq-top .mq-i span {
                ...
                -webkit-text-stroke: 1.5px #F2EDE6
            }
...
═══════════════════════════════════ */
        ...
        .op-br.tr {
            top: 22px;
            right: 22px;
            border-top: 2px solid rgba(242, 237, 230, .2);
            border-right: 2px solid rgba(242, 237, 230, .2)
        }

        .op-br.bl {
            bottom: 22px;
            left: 22px;
            border-bottom: 2px solid rgba(242, 237, 230, .2);
        ...
        .op-in-1 {
            animation: op-fade-in .7s .2s both ease
        }

        .op-in-2 {
            animation: op-fade-in .7s .4s both ease
        }

        .op-in-3 {
            animation: op-fade-in .7s .55s both ease
        }

        .op-in-4 {
            animation: op-fade-in .7s .7s both ease
        }

        .op-in-5 {
            animation: op-fade-in .7s .85s both ease
        }
    </style>
</head>
...
<body>
    ...
    <nav id="bnav">
        ...
        <div class="bn" onclick="goTo(3)" data-i="3"><i class="fa-solid fa-calendar-star"></i><span>Acara</span>
        </div>
        <div class="bn" onclick="goTo(4)" data-i="4"><i class="fa-solid fa-images"></i><span>Galeri</span></div>
        <div class="bn" onclick="goTo(5)" data-i="5"><i class="fa-solid fa-pen-to-square"></i><span>RSVP</span>
        </div>
        <div class="bn" onclick="goTo(6)" data-i="6"><i class="fa-solid fa-comment-dots"></i><span>Wishes</span>
        </div>
    </nav>
        ...
        <div class="op-main">
            ...
            <div class="op-meta op-in-4">
                @if ($invitation->events->count())
                    ...
                    {{ $invitation->events->first()->start_time }} WIB
                @else
    ...
    <div id="sc">
        ...
        <section class="snap" id="s1">
            <div class="s1-grid" style="flex:1;overflow:hidden">
                <div class="s1-left">
                    <p class="s1-tag" data-r>Birthday Invitation &nbsp;·&nbsp;
                        {{ optional($invitation->event_date)->format('Y') }}</p>
                    <h1 class="s1-name" data-r>
                        @foreach (explode(' ', $invitation->profile->first_name ?? 'Name') as $word)
                            @if ($loop->even)
                                <em>{{ $word }}</em>@else{{ $word }}
                            @endif
                        @endforeach
                    </h1>
                ...
                <div class="s1-right">
                    ...
                    @if ($invitation->cover?->file_path)
                        <div
                            style="position:absolute;inset:0;background-image:url('{{ asset('storage/' . $invitation->cover->file_path) }}');background-size:cover;background-position:center;opacity:.1;mix-blend-mode:multiply;pointer-events:none">
                        </div>
                    @endif
                </div>
            </div>
        ...
        <section class="snap" id="s2" style="background:#F2EDE6">
            ...
            <div class="s2-body">
                <div class="s2-photo-wrap" data-r="l">
                    ...
                    @else
                        <div
                            style="width:100%;height:100%;background:rgba(17,17,17,.06);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:10px">
                            <span style="font-size:2.5rem;opacity:.18">📷</span>
                            <span class="f-mono"
                                style="font-size:9px;letter-spacing:.2em;opacity:.28;text-transform:uppercase">Upload
                                Photo</span>
                        </div>
                    @endif
                </div>
                <div class="s2-text" data-r>
                    ...
                    <p class="s2-body-text">Dengan segenap kebahagiaan, mengundang Anda untuk merayakan hari istimewa
                        ini bersama orang-orang tersayang.</p>
        ...
        <section class="snap" id="s3">
            ...
            <div class="s3-cd" data-r>
                <div class="s3-unit"><span class="s3-n" id="cd-d">--</span><span class="s3-l">Hari</span>
                </div>
                <div class="s3-unit"><span class="s3-n" id="cd-h">--</span><span class="s3-l">Jam</span>
                </div>
                <div class="s3-unit"><span class="s3-n" id="cd-m">--</span><span class="s3-l">Menit</span>
                </div>
                <div class="s3-unit"><span class="s3-n" id="cd-s">--</span><span class="s3-l">Detik</span>
                </div>
            </div>
        </section>
        ...
        <section class="snap" id="s4">
            <div class="s4-head">
                ...
                <p class="s4-subtitle f-mono" data-r>
                    {{ optional($invitation->event_date)->translatedFormat('l, d F Y') }}</p>
            </div>
                    ...
                    <div class="s4-item">
                        ...
                        <div>
                            ...
                            <div class="s4-ev-btns">
                                <a class="s4-btn" href="https://maps.google.com/?q={{ urlencode($event->address) }}"
                                    target="_blank">&#8599; Maps</a>
                                <button class="s4-btn s4-btn-r"
            ...
            <div class="s4-bot-strip"
                style="flex-shrink:0;margin-top:auto;overflow:hidden;white-space:nowrap;padding:12px 0;border-top:1px solid rgba(17,17,17,.08)">
                <div class="mq-i" style="animation-duration:20s">
                    @foreach (['★ BIRTHDAY PARTY', '· CELEBRATE LIFE ·', '★ MAKE A WISH', '· GOOD TIMES ·', '★ BIRTHDAY PARTY', '· CELEBRATE LIFE ·', '★ MAKE A WISH', '· GOOD TIMES ·'] as $bt)
                        <span class="f-mono"
                            style="font-size:11px;letter-spacing:.28em;text-transform:uppercase;color:rgba(17,17,17,.2);padding:0 20px">{{ $bt }}</span>
                    @endforeach
                </div>
            </div>
        </section>
        ...
        <section class="snap" id="s6">
            <div class="s6-layout">
                <div class="s6-left">
                    ...
                    <p class="f-mono" data-r>Konfirmasi kehadiran<br>sebelum
                        <strong>{{ optional($invitation->event_date)->format('d M Y') }}</strong></p>
                </div>
                <div data-r>
                    <form id="rsvp-form" onsubmit="doRsvp(event)">
                        <input class="s6-inp" type="text" name="name" placeholder="Nama Anda"
            ...
            <div class="s7-layout">
                <div class="s7-sidebar">
                    ...
                    <form id="wish-form" onsubmit="doWish(event)" data-r>
                        <input class="w-inp" type="text" name="wn" placeholder="Nama Anda"
                            value="{{ request()->get('to') }}" required>
                        <textarea class="w-inp" name="wm" rows="3" placeholder="Tuliskan doa &amp; ucapan terbaik Anda..."
                            required></textarea>
                ...
                <div style="overflow:hidden;display:flex;flex-direction:column">
                    <p class="f-mono"
                        style="font-size:10px;letter-spacing:.3em;text-transform:uppercase;color:rgba(17,17,17,.28);margin-bottom:18px;flex-shrink:0"
                        data-r>— Ucapan dari tamu</p>
                    <div id="wlist">
                        <div class="witem">
                            <div class="witem-name f-mono">Tim Undangan</div>
                            <p class="witem-msg">"Semoga hari ulang tahunmu penuh kebahagiaan dan semua harapan
                                terkabul!"</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="snap" id="s8">
            <div class="s8-layout">
                <div data-r="l">
                    ...
                    <p class="s8-sub">Kehadiran Anda adalah hadiah terbaik. Namun jika ingin memberikan tanda kasih:
                    </p>
                    ...
                    <p class="s8-val f-anton" style="font-size:clamp(1.1rem,2.5vw,1.8rem)">
        ...
        <section class="snap" id="s9">
            ...
            <div class="s9-center">
                ...
                <h2 class="s9-main f-anton" data-r>
                    ...
                    <span class="outline-w"
                        style="-webkit-text-stroke:2px #F2EDE6">{{ $invitation->profile->first_name ?? '' }}</span>
                </h2>
                <p class="s9-body" data-r>Merupakan kehormatan bagi kami atas kehadiran serta doa baik Anda. Sampai
                    jumpa di hari yang penuh warna!</p>
            ...
            <div class="mq s9-mq-bot" style="flex-shrink:0;padding:10px 0;overflow:hidden;background:rgba(0,0,0,.1)">
                <div class="mq-i mq-rev" style="animation-duration:20s">
                    @foreach (['● CELEBRATE LIFE', '· GOOD TIMES ·', '● MAKE A WISH', '· CHEERS ·', '● BIRTHDAY BASH', '· LET\'S PARTY ·', '● CELEBRATE LIFE', '· GOOD TIMES ·', '● MAKE A WISH', '· CHEERS ·', '● BIRTHDAY BASH', '· LET\'S PARTY ·'] as $t)
                        <span class="f-mono"
                            style="font-size:clamp(9px,1.2vw,12px);letter-spacing:.32em;color:rgba(242,237,230,.6);text-transform:uppercase;padding:0 18px">{{ $t }}</span>
                    @endforeach
                </div>
            </div>
            ...
            <div class="mq" style="flex-shrink:0;padding:8px 0;overflow:hidden">
                <div class="mq-i" style="animation-duration:14s">
                    @foreach (array_fill(0, 10, $invitation->profile->first_name ?? 'Birthday') as $n)
                        <span class="f-anton"
                            style="font-size:clamp(1.2rem,4vw,2.5rem);color:transparent;-webkit-text-stroke:1px rgba(242,237,230,.25);padding:0 16px;letter-spacing:.06em">{{ strtoupper($n) }}</span>
                    @endforeach
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        document.querySelectorAll('a,button').forEach(el => {
            el.addEventListener('mouseenter', () => {
                curEl.style.width = '26px';
                curEl.style.height = '26px';
            });
