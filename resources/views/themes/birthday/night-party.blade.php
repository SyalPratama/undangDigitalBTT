...
<body class="bg-[#09090b] text-[#f4f4f5] antialiased envelope-active">
    ...
    <div id="envelopeOverlay"
        ...
        <div class="max-w-xl text-center px-6 z-10">
            <span
                class="font-header text-xs tracking-[0.4em] text-[#f59e0b] bg-[#f59e0b]/10 px-4 py-1.5 rounded-full mb-8 inline-block">YOU
                ARE INVITED</span>

            <h2
                class="font-header text-4xl md:text-6xl font-extrabold text-white uppercase tracking-tight leading-none mb-4">
                {{ $invitation->profile->first_name ?? 'Birthday' }}'s
                <span
                    class="block neon-gold-text font-accent lowercase italic font-normal tracking-normal py-2">celebration</span>
            </h2>

            <div class="w-16 h-[2px] bg-gradient-to-r from-transparent via-[#f59e0b] to-transparent mx-auto my-8"></div>

            <p class="text-[11px] uppercase tracking-[0.2em] text-zinc-500 mb-3">Admit One Exclusive Guest:</p>
            ...
            <div
                ...
                <span class="text-[10px] text-zinc-500 font-bold tracking-widest block uppercase mb-1">VIP PASS</span>
                <p class="font-header text-xl font-bold text-white tracking-wide uppercase">
                    {{ request()->get('to') ?? 'Sahabat Terbaik' }}
                </p>
            </div>
            ...
            <button onclick="openInvitation()"
                ...
                <span class="flex items-center gap-2">
                    <i class="fa-solid fa-ticket text-xs"></i> Open Invitation
                </span>
            </button>
        </div>
    </div>
    ...
    <section class="relative min-h-screen grid md:grid-cols-12 items-stretch overflow-hidden">
        <div
            ...
            <div class="flex justify-between items-center">
                <span class="font-header text-xs text-[#f59e0b] tracking-widest font-bold">LET'S PARTY!</span>
            ...
            <div class="my-auto py-16 md:py-0 relative">
                <h1
                    ...
                    B-DAY</h1>
                <p class="font-accent text-3xl italic text-[#f59e0b] mb-4">You're invited to...</p>
                <h2
                    class="font-header text-5xl md:text-7xl font-extrabold text-white uppercase tracking-tight leading-none mb-2">
                    {{ $invitation->profile->first_name }}
                </h2>
                <h2
                    class="font-header text-4xl md:text-5xl font-extrabold text-zinc-500 uppercase tracking-tight leading-none mb-6">
                    {{ $invitation->profile->second_name ?? 'Turns 25!' }}
                </h2>
                <p class="text-sm text-zinc-400 font-light max-w-sm leading-relaxed">
                    Tahun ini penuh berkah, dan tidak ada cara yang lebih baik untuk merayakannya selain berdansa,
                    tertawa, dan menghabiskan malam bersama orang-orang tercinta.
                </p>
            </div>

            <div class="border-t border-zinc-800 pt-8 grid grid-cols-2 gap-4">
                <div>
                    <span class="text-[10px] block uppercase text-zinc-500 tracking-wider font-semibold mb-1">Save The
                        Date</span>
                    <span
                ...
                <div class="text-right">
                    <span class="text-[10px] block uppercase text-zinc-500 tracking-wider font-semibold mb-1">Dress
                        Code</span>
                    <span class="text-sm text-[#f59e0b] font-bold uppercase tracking-wider">Elegant Black & Gold</span>
                </div>
            </div>
        </div>
        ...
        <div class="md:col-span-6 relative min-h-[40vh] md:min-h-screen flex items-end p-8 md:p-16">
            <div class="absolute inset-0 bg-cover bg-center filter contrast-[105%] brightness-[45%]"
                style="background-image: url('{{ $invitation->cover?->file_path ? asset('storage/' . $invitation->cover->file_path) : 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?q=80&w=2000' }}');">
            </div>
            ...
            <div class="relative z-10 max-w-sm neon-gold-border bg-[#09090b]/80 backdrop-blur-md p-6 rounded-2xl">
                ...
                <p class="font-accent text-lg italic text-zinc-200 leading-relaxed">
                    "{{ $invitation->profile->quote ?? 'Count your age by friends, not years. Count your life by smiles, not tears.' }}"
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#09090b] py-36 px-6 relative overflow-hidden text-center">
        <div class="max-w-xl mx-auto relative">
            <div class="mb-8 relative inline-block group">
                ...
                @else
                    <div
                        ...
                        <i class="fa-solid fa-cake-candles"></i></div>
                @endif
            </div>

            <span class="font-header text-[10px] text-[#f59e0b] tracking-[0.4em] block uppercase mb-2">The Birthday
                Star</span>
            <h3 class="font-header text-4xl text-white font-extrabold uppercase tracking-tight">
            ...
            <p class="text-sm text-zinc-400 leading-relaxed font-light">
                Ungkapan rasa syukur yang tak terhingga kepada Tuhan Yang Maha Esa atas bertambahnya usia ini. Bersama
                kedua orang tua tercinta, Bapak <span
                ...
                sangat menantikan kehadiran kalian untuk mengukir memori malam pesta yang tak terlupakan!
            </p>
        </div>
    </section>
    ...
    <section class="py-36 px-6 bg-[#141416] relative overflow-hidden border-t border-b border-zinc-800">
        ...
        <div class="max-w-5xl mx-auto relative z-10">
            <div class="text-center mb-24">
                <span class="font-header text-[11px] tracking-[0.4em] text-[#f59e0b] block uppercase mb-2">WHEN &
                    WHERE</span>
                    ...
                    <div
                        ...
                        <div class="mt-8 pt-6 border-t border-zinc-900 text-left">
                            <a href="https://maps.google.com/?q={{ urlencode($event->address) }}" target="_blank"
                                ...
                                <i class="fa-solid fa-diamond-turn-right text-[10px]"></i> Open Venue Maps
                            </a>
                        </div>
                    </div>
                @endforeach
    ...
    <section class="bg-[#09090b] py-36 px-6 relative overflow-hidden">
        <div class="max-w-6xl mx-auto relative z-10">
            <div class="text-center mb-20">
                <span class="font-header text-[11px] tracking-[0.4em] text-[#f59e0b] block uppercase mb-2">MEMORIES
                    SHOT</span>
                <h2 class="font-header text-4xl md:text-5xl text-white font-extrabold uppercase tracking-tight">
                    PHOTO ALBUM
                </h2>
    ...
    <section class="py-40 px-6 bg-[#141416] relative text-center border-t border-zinc-800">
        ...
        <div class="max-w-3xl mx-auto z-10 relative">
            ...
            <p class="text-zinc-400 font-light text-sm md:text-base leading-loose max-w-xl mx-auto mb-12">
                Kehadiran dan doa tulus rekan-rekan sekalian adalah hadiah paling berharga yang melengkapi kebahagiaan
                perayaan ulang tahun ini. Sampai jumpa di lantai dansa!
            </p>

            <span class="font-header text-[10px] tracking-[0.3em] text-[#f59e0b] block uppercase mb-3">Cheers, with
                love</span>
            <div class="mt-2">
                <h3 class="font-header text-3xl md:text-5xl font-extrabold text-white uppercase tracking-tight">
                    {{ $invitation->profile->first_name }}
                </h3>
            </div>
        </div>
