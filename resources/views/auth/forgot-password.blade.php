...
<head>
    ...
    <title>Ngajak.my.id | Reset Password</title>
    ...
    <div class="w-full max-w-md bg-white rounded-3xl p-8 sm:p-10 shadow-xl">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-xs text-slate-500 mt-2">
                Tidak masalah. Masukkan email Anda dan kami akan mengirimkan tautan untuk mengatur ulang sandi.
            </p>
        </div>

        <form method="POST" action="/password/email" class="space-y-4">

            <div>
                <div class="input-wrapper">
                    <span class="input-icon"><i class="fa-regular fa-envelope"></i></span>
                    <input type="email" name="email" required placeholder="nama@email.com" class="input-field" />
                </div>
            </div>
        ...
        <div class="mt-6 text-center">
            <a href="/login" class="text-xs font-semibold text-slate-500 hover:text-pink-600 transition">
