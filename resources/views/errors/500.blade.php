...
<body class="bg-gradient-to-br from-[#f4e6fa] via-[#e5f4fd] to-[#d6fbfb] min-h-screen flex items-center justify-center p-6 text-slate-800">
    <div class="max-w-md w-full bg-white/70 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white text-center">
        ...
        <h1 class="font-serif text-[42px] font-bold text-slate-900 tracking-tight leading-none mb-4">500</h1>
        <h2 class="text-lg font-bold text-slate-700 mb-2">Terjadi Kesalahan Server</h2>
        <p class="text-sm text-slate-500 mb-8 leading-relaxed">
            Wah, ada sesuatu yang salah di sisi kami. Kami sedang berusaha memperbaikinya. Silakan coba lagi nanti.
        </p>
        <button onclick="window.location.reload()" class="inline-flex items-center justify-center gap-2 w-full py-3.5 bg-[#6d28d9] hover:bg-[#5b21b6] text-white rounded-full font-semibold text-sm transition-all shadow-md shadow-purple-500/20">
