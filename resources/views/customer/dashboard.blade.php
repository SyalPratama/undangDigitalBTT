...
@section('content')
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="{{ route('customer.kelola-undangan.index') }}" class="inline-flex items-center gap-2 bg-[#6d28d9] hover:bg-[#5b21b6] text-white px-6 py-2.5 rounded-full font-medium text-[14px] transition-all shadow-sm">
        ...
        <div class="bg-white/70 backdrop-blur-xl rounded-[2rem] p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.02)] border border-white mt-8">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="{{ route('customer.kelola-undangan.index') }}" class="text-[13px] font-medium text-slate-500 hover:text-slate-800">View all</a>
            </div>
