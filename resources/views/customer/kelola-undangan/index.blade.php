                ...
                @forelse($invitations as $invitation)
                    <div class="py-5 flex flex-col md:flex-row md:items-center justify-between gap-4 group transition-colors">
                        ...
                        <div class="flex items-center gap-3 shrink-0">
                            ...
                            {{-- Delete Button --}}
                            <form action="{{ route('customer.kelola-undangan.destroy', $invitation->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Apakah Anda yakin ingin menghapus undangan ini?');">
                                @csrf
                                @method('DELETE')
