...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <div class="flex items-center gap-3">
            ...
            @endif
            <a href="{{ route('customer.kelola-undangan.map', $invitation->id) }}" class="inline-flex items-center gap-1.5 px-4 py-1.5 bg-white border border-slate-200 text-slate-700 rounded-full text-[11px] font-bold tracking-wide hover:bg-slate-50 transition-colors shadow-sm">
