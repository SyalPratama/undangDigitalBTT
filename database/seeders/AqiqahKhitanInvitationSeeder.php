...
class AqiqahKhitanInvitationSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $graduation = Invitation::create([
            ...
            'theme_id' => $theme->id,
            'slug' => 'wisuda-muhamad-davina',
            'title' => 'Tasyakuran Wisuda Muhamad & Davina',
            'is_active' => true,
            'published_at' => now(),
            'event_date' => '2026-11-25',
            'visitor_count' => 0,
            'meta_title' => 'Tasyakuran Wisuda Muhamad & Davina',
            'meta_description' => 'Momen kebahagiaan kelulusan akademis kami.',
        ]);
        ...
        InvitationProfile::create([
            ...
            'second_name' => 'Davina Karamoy, S.Kom.',
            'first_nickname' => 'Muhamad',
            'second_nickname' => 'Davina',
            'first_father' => 'Abdullah Salam',
            'first_mother' => 'Siti Rahmawati',
